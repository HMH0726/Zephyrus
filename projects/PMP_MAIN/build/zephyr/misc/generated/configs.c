...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF_QDEC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_QDEC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_QDEC_NRFX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_TCP_TIME_WAIT_DELAY, 200);
